...
namespace MySTL
{
    ...
    public:
        ...
        vector& operator=(const vector &);								// assign content: copy
        vector& operator=(initializer_list<T>);						    // assign content: initializer list
        vector& operator=(vector &&) noexcept;							// assign content: move
        ~vector();                                                      // destructor
